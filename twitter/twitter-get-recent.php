<?php
  ...
  /**
   *
   * FILE FROM: https://github.com/andrewbiggart/latest-tweets-php-o-auth/
   *
   * CREDITS:
   ...
   *
   * ------------------------------------------------
   * ---- END J2 | BEGIN LATEST TWEETS PHP OAUTH ----
   * ------------------------------------------------
   *
   *
   * Notes:
  ...
  **/
  ...
  function display_latest_tweets(
    ...
    $twitter_wrap_open   = '<ul class="slides">',
    $twitter_wrap_close  = '</ul>',
    $tweet_wrap_open     = '<li>',
    $meta_wrap_open      = '<p class="tweet-meta">',
    $time_open           = '<span class="tweet-time">',
    $time_close          = '</span>',
    $meta_wrap_close     = '</p><p class="tweet-text">',
